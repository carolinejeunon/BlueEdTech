...
class Urna {
    ...
    exibirResultados (){
        ...
        this.listaVotos = this.listaVotos.filter(item => item.opcao != "voto nulo" && item.opcao != "voto em branco");
        
        if (this.listaVotos[this.listaVotos.length-1].numeroVotos !== this.listaVotos[this.listaVotos.length-2]?.numeroVotos){
